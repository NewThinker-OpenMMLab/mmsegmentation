...
# QUANT=fp16
# QUANT=int8
mmdeploy_config=segmentation_tensorrt-${QUANT}_static-480x848.py
...
WORKDIR=$my_dir/output_models/tensorrt_480x848/$OUTPUT_MODEL_NAME
EXAMPLE_IMG=$my_dir/example_images/example_image_480x848.jpg
