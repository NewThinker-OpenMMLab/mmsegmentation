...
# QUANT=fp16
# QUANT=int8
mmdeploy_config=segmentation_tensorrt-${QUANT}_static-160x282.py
...
WORKDIR=$my_dir/output_models/tensorrt_160x282/$OUTPUT_MODEL_NAME
EXAMPLE_IMG=$my_dir/example_images/example_image_160x282.jpg
